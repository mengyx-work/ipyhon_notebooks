...
from speech.speech_model.data_preprocess import categorize_wav_files_by_label, generate_label_dict, \
    generate_proportional_data_sets
...
def process_and_split_data_by_chunk(wav_files, noise_generator, chunk_size=2000, window_length=5000, sample_rate=16000,
    ...
    for i in range(len(wav_files)):
        ...
        #print fbank_features.shape, len(samples), sample_rate, wav_files[i][0]
...
def preprocess_data(data_path):
    ...
    process_and_split_data_by_chunk(training_samples_, noise_generator)
